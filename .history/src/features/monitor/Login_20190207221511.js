...
export class Login extends Component {
  ...
  render() {
    ...
    const userNamePlaceHolder = intl.formatMessage({ id: 'login_username' });
    const passwordPlaceHolder = intl.formatMessage({ id: 'login_password' });
    const userNameMessage = intl.formatMessage({ id: 'login_username_message' });
    const passwordMessage = intl.formatMessage({ id: 'login_password_message' });
    const loginSubmitValue = intl.formatMessage({ id: 'login_submit_value' });
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(injectIntl(WrappedHorizontalLoginForm));
